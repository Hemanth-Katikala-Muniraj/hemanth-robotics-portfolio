...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    // ✅ Always visible by default (prevents "invisible footer" bugs)
    gsap.set(wrap, { opacity: 1, y: 0, clearProps: "transform" });
    gsap.set(content, { opacity: 1, y: 0 });

    const ctx = gsap.context(() => {
      // Animate content in when footer enters viewport
  ...
  return (
    <footer
      ref={footerWrapRef}
      className="relative py-16 px-6 border-t border-border/30 overflow-hidden opacity-100"
    >
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div>
              <p className="text-muted-foreground leading-relaxed mb-6">
                Building deployable robotics systems with ROS2, perception, planning, and control — with a focus on integration,
